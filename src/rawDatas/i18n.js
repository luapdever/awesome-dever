...
export const SKILL_CAT = {
  ...
  "AI / LLM": L("AI / LLM", "IA / LLM"),
  "Search & relevance": L("Search & relevance", "Recherche & pertinence"),
  "Mobile & Desktop": L("Mobile & Desktop", "Mobile & Desktop"),
  ...
  "Observability & Monitoring": L("Observability & Monitoring", "Observabilité & monitoring"),
...
export const STR = {
  en: {
    ...
    wDo: [
      ...
      "Containerized DevOps — Docker Swarm, CI/CD, observability",
    ],
    wExplore: "Jump in",
    // Contact
    cTitle: "Get in touch",
  ...
  fr: {
    ...
    wDo: [
      ...
      "DevOps conteneurisé — Docker Swarm, CI/CD, observabilité",
    ],
    wExplore: "Explorer",
